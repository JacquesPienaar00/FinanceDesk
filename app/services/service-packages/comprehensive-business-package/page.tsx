...
export default function Component() {
  const product: Product = {
    name: servicesPackages[1].text,
    title: servicesPackages[1].text,
    thumbnail: servicesPackages[1].src.src,
    id: servicesPackages[1].id.toString(),
    mrp: Number(servicesPackages[1].mrp),
    salePrice: Number(servicesPackages[1].salePrice),
    category: servicesPackages[1].category,
  };
