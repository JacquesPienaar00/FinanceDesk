...
export default function Component() {
  const product: Product = {
    name: servicesPackages[2].text,
    title: servicesPackages[2].text,
    thumbnail: servicesPackages[2].src.src,
    id: servicesPackages[2].id.toString(),
    mrp: Number(servicesPackages[2].mrp),
    salePrice: Number(servicesPackages[2].salePrice),
    category: servicesPackages[2].category,
  };
