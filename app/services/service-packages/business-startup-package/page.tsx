...
export default function Component() {
  const product: Product = {
    name: servicesPackages[0].text,
    title: servicesPackages[0].text,
    thumbnail: servicesPackages[0].src.src,
    id: servicesPackages[0].id.toString(),
    mrp: Number(servicesPackages[0].mrp),
    salePrice: Number(servicesPackages[0].salePrice),
    category: servicesPackages[0].category,
  };
