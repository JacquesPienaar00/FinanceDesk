...
export default function Component() {
  const product: Product = {
    name: servicesPackages[3].text,
    title: servicesPackages[3].text,
    thumbnail: servicesPackages[3].src.src,
    id: servicesPackages[3].id.toString(),
    mrp: Number(servicesPackages[3].mrp),
    salePrice: Number(servicesPackages[3].salePrice),
    category: servicesPackages[3].category,
  };
