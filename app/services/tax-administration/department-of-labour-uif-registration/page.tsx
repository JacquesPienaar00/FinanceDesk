...
export default function Component() {
  const product: Product = {
    name: taxAdministration[2].text,
    title: taxAdministration[2].text,
    thumbnail: taxAdministration[2].src.src,
    id: taxAdministration[2].id.toString(),
    mrp: Number(taxAdministration[2].mrp),
    salePrice: Number(taxAdministration[2].salePrice),
    category: taxAdministration[2].category,
  };
