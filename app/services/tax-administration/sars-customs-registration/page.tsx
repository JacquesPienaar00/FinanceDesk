...
export default function Component() {
  const product: Product = {
    name: taxAdministration[7].text,
    title: taxAdministration[7].text,
    thumbnail: taxAdministration[7].src.src,
    id: taxAdministration[7].id.toString(),
    mrp: Number(taxAdministration[7].mrp),
    salePrice: Number(taxAdministration[7].salePrice),
    category: taxAdministration[7].category,
  };
