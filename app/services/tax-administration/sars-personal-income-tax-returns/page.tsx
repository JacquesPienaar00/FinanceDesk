...
export default function Component() {
  const product: Product = {
    name: taxAdministration[9].text,
    title: taxAdministration[9].text,
    thumbnail: taxAdministration[9].src.src,
    id: taxAdministration[9].id.toString(),
    mrp: Number(taxAdministration[9].mrp),
    salePrice: Number(taxAdministration[9].salePrice),
    category: taxAdministration[9].category,
  };
