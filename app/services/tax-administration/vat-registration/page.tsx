...
export default function Component() {
  const product: Product = {
    name: taxAdministration[6].text,
    title: taxAdministration[6].text,
    thumbnail: taxAdministration[6].src.src,
    id: taxAdministration[6].id.toString(),
    mrp: Number(taxAdministration[6].mrp),
    salePrice: Number(taxAdministration[6].salePrice),
    category: taxAdministration[6].category,
  };
