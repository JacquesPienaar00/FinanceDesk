...
export default function Component() {
  const product: Product = {
    name: taxAdministration[8].text,
    title: taxAdministration[8].text,
    thumbnail: taxAdministration[8].src.src,
    id: taxAdministration[8].id.toString(),
    mrp: Number(taxAdministration[8].mrp),
    salePrice: Number(taxAdministration[8].salePrice),
    category: taxAdministration[8].category,
  };
