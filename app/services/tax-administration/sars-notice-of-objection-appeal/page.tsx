...
export default function Component() {
  const product: Product = {
    name: taxAdministration[0].text,
    title: taxAdministration[0].text,
    thumbnail: taxAdministration[0].src.src,
    id: taxAdministration[0].id.toString(),
    mrp: Number(taxAdministration[0].mrp),
    salePrice: Number(taxAdministration[0].salePrice),
    category: taxAdministration[0].category,
  };
