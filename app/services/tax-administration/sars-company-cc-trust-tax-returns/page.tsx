...
export default function Component() {
  const product: Product = {
    name: taxAdministration[1].text,
    title: taxAdministration[1].text,
    thumbnail: taxAdministration[1].src.src,
    id: taxAdministration[1].id.toString(),
    mrp: Number(taxAdministration[1].mrp),
    salePrice: Number(taxAdministration[1].salePrice),
    category: taxAdministration[1].category,
  };
