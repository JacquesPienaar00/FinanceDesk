...
export default function Component() {
  const product: Product = {
    name: taxAdministration[5].text,
    title: taxAdministration[5].text,
    thumbnail: taxAdministration[5].src.src,
    id: taxAdministration[5].id.toString(),
    mrp: Number(taxAdministration[5].mrp),
    salePrice: Number(taxAdministration[5].salePrice),
    category: taxAdministration[5].category,
  };
