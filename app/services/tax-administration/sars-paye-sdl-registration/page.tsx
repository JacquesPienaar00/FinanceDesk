...
export default function Component() {
  const product: Product = {
    name: taxAdministration[3].text,
    title: taxAdministration[3].text,
    thumbnail: taxAdministration[3].src.src,
    id: taxAdministration[3].id.toString(),
    mrp: Number(taxAdministration[3].mrp),
    salePrice: Number(taxAdministration[3].salePrice),
    category: taxAdministration[3].category,
  };
