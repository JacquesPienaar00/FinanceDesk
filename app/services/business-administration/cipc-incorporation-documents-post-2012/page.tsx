...
export default function Component() {
  const product: Product = {
    name: businessAdministation[11].text,
    title: businessAdministation[11].text,
    thumbnail: businessAdministation[11].src.src,
    id: businessAdministation[11].id.toString(),
    mrp: Number(businessAdministation[11].mrp),
    salePrice: Number(businessAdministation[11].salePrice),
    category: businessAdministation[11].category,
  };
