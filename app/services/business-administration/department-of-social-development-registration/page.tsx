...
export default function Component() {
  const product: Product = {
    name: businessAdministation[7].text,
    title: businessAdministation[7].text,
    thumbnail: businessAdministation[7].src.src,
    id: businessAdministation[7].id.toString(),
    mrp: Number(businessAdministation[7].mrp),
    salePrice: Number(businessAdministation[7].salePrice),
    category: businessAdministation[7].category,
  };
