...
export default function Component() {
  const product: Product = {
    name: businessAdministation[2].text,
    title: businessAdministation[2].text,
    thumbnail: businessAdministation[2].src.src,
    id: businessAdministation[2].id.toString(),
    mrp: Number(businessAdministation[2].mrp),
    salePrice: Number(businessAdministation[2].salePrice),
    category: businessAdministation[2].category,
  };
