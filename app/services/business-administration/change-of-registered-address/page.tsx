...
export default function Component() {
  const product: Product = {
    name: businessAdministation[10].text,
    title: businessAdministation[10].text,
    thumbnail: businessAdministation[10].src.src,
    id: businessAdministation[10].id.toString(),
    mrp: Number(businessAdministation[10].mrp),
    salePrice: Number(businessAdministation[10].salePrice),
    category: businessAdministation[10].category,
  };
