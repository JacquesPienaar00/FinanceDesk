...
export default function Component() {
  const product: Product = {
    name: businessAdministation[4].text,
    title: businessAdministation[4].text,
    thumbnail: businessAdministation[4].src.src,
    id: businessAdministation[4].id.toString(),
    mrp: Number(businessAdministation[4].mrp),
    salePrice: Number(businessAdministation[4].salePrice),
    category: businessAdministation[4].category,
  };
