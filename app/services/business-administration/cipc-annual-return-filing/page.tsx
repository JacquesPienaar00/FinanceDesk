...
export default function Component() {
  const product: Product = {
    name: businessAdministation[0].text,
    title: businessAdministation[0].text,
    thumbnail: businessAdministation[0].src.src,
    id: businessAdministation[0].id.toString(),
    mrp: Number(businessAdministation[0].mrp),
    salePrice: Number(businessAdministation[0].salePrice),
    category: businessAdministation[0].category,
  };
