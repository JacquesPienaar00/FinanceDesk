...
export default function Component() {
  const product: Product = {
    name: businessAdministation[12].text,
    title: businessAdministation[12].text,
    thumbnail: businessAdministation[12].src.src,
    id: businessAdministation[12].id.toString(),
    mrp: Number(businessAdministation[12].mrp),
    salePrice: Number(businessAdministation[12].salePrice),
    category: businessAdministation[12].category,
  };
