...
export default function Component() {
  const product: Product = {
    name: businessAdministation[8].text,
    title: businessAdministation[8].text,
    thumbnail: businessAdministation[8].src.src,
    id: businessAdministation[8].id.toString(),
    mrp: Number(businessAdministation[8].mrp),
    salePrice: Number(businessAdministation[8].salePrice),
    category: businessAdministation[8].category,
  };
