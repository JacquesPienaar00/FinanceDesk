...
import businessAdministation from '@/public/icons/businessAdministation';
...
export default function Component() {
  const product: Product = {
    name: businessAdministation[3].text,
    title: businessAdministation[3].text,
    thumbnail: businessAdministation[3].src.src,
    id: businessAdministation[3].id.toString(),
    mrp: Number(businessAdministation[3].mrp),
    salePrice: Number(businessAdministation[3].salePrice),
    category: businessAdministation[3].category,
  };
          ...
          <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2">
            <div className="space-y-4">
              ...
              <p className="max-w-[600px] text-gray-600 md:text-lg">
                ...
                comprehensive suite of features and personalized support, we&rsquo;ll work closely
                with you to optimize your operations and drive sustainable growth.
              </p>
            </div>
