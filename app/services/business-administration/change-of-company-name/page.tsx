...
export default function Component() {
  const product: Product = {
    name: businessAdministation[6].text,
    title: businessAdministation[6].text,
    thumbnail: businessAdministation[6].src.src,
    id: businessAdministation[6].id.toString(),
    mrp: Number(businessAdministation[6].mrp),
    salePrice: Number(businessAdministation[6].salePrice),
    category: businessAdministation[6].category,
  };
          ...
          <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2">
            <div className="space-y-4">
              ...
              <p className="max-w-[600px] text-gray-600 md:text-lg">
                ...
                comprehensive suite of features and personalized support, we&apos;ll work closely
