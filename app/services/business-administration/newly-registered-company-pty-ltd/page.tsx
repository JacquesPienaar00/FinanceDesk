...
export default function Component() {
  const product: Product = {
    name: businessAdministation[5].text,
    title: businessAdministation[5].text,
    thumbnail: businessAdministation[5].src.src,
    id: businessAdministation[5].id.toString(),
    mrp: Number(businessAdministation[5].mrp),
    salePrice: Number(businessAdministation[5].salePrice),
    category: businessAdministation[5].category,
  };
