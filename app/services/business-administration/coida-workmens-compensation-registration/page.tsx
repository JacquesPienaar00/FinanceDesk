...
export default function Component() {
  const product: Product = {
    name: businessAdministation[1].text,
    title: businessAdministation[1].text,
    thumbnail: businessAdministation[1].src.src,
    id: businessAdministation[1].id.toString(),
    mrp: Number(businessAdministation[1].mrp),
    salePrice: Number(businessAdministation[1].salePrice),
    category: businessAdministation[1].category,
  };
