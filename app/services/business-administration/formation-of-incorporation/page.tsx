...
export default function Component() {
  const product: Product = {
    name: businessAdministation[9].text,
    title: businessAdministation[9].text,
    thumbnail: businessAdministation[9].src.src,
    id: businessAdministation[9].id.toString(),
    mrp: Number(businessAdministation[9].mrp),
    salePrice: Number(businessAdministation[9].salePrice),
    category: businessAdministation[9].category,
  };
