...
import financialAdvisory from '@/public/icons/financialAdvisory';
...
export default function Component() {
  const product: Product = {
    name: financialAdvisory[0].text,
    title: financialAdvisory[0].text,
    thumbnail: financialAdvisory[0].src.src,
    id: financialAdvisory[0].id.toString(),
    mrp: Number(financialAdvisory[0].mrp),
    salePrice: Number(financialAdvisory[0].salePrice),
    category: financialAdvisory[0].category,
  };
