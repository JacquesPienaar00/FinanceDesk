...
export default function Component() {
  const product: Product = {
    name: financialAdvisory[1].text,
    title: financialAdvisory[1].text,
    thumbnail: financialAdvisory[1].src.src,
    id: financialAdvisory[1].id.toString(),
    mrp: Number(financialAdvisory[1].mrp),
    salePrice: Number(financialAdvisory[1].salePrice),
    category: financialAdvisory[1].category,
  };
