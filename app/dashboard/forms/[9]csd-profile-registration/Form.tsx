...
const formSchema = z.object({
  ...
  bankAccountConfirmation: z.any().refine((file) => file?.length > 0, "Bank account confirmation is required"),
  bbbeeAffidavit: z.any().optional(),
  cipcDocument: z.any().refine((file) => file?.length > 0, "CIPC registration document is required"),
});
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="space-y-2">
          ...
          {errors.natureOfTrade && (
            <p className="text-red-500 text-sm">{errors.natureOfTrade.message as React.ReactNode}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          {errors.descriptionOfServices && (
            <p className="text-red-500 text-sm">{errors.descriptionOfServices.message as React.ReactNode}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          {errors.cellNumber && (
            <p className="text-red-500 text-sm">{errors.cellNumber.message as React.ReactNode}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          {(errors.otpDate || errors.otpTime) && (
            <p className="text-red-500 text-sm">Please select both date and time for OTP finalization</p>
          )}
        </div>
        ...
        {registrationMethod === "upload" && (
          <div className="space-y-2">
            ...
            {errors.cipcRegistrationDocument && (
              <p className="text-red-500 text-sm">{errors.cipcRegistrationDocument.message as React.ReactNode}</p>
            )}
          </div>
        )}
        ...
        {registrationMethod === "number" && (
          <div className="space-y-2">
            ...
            {errors.cipcRegistrationNumber && (
              <p className="text-red-500 text-sm">{errors.cipcRegistrationNumber.message as React.ReactNode}</p>
            )}
          </div>
        )}
        ...
        <div className="space-y-2">
          ...
          {errors.bankAccountConfirmation && (
            <p className="text-red-500 text-sm">{errors.bankAccountConfirmation.message as React.ReactNode}</p>
          )}
        </div>
