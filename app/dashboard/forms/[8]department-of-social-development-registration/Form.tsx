...
export function DepartmentOfSocialDevelopmentRegistrationForm({
  ...
  const handleNextStep = async () => {
    const fieldsToValidate = currentStep === 0
      ? ["organizationName", "registrationMethod", "registrationNumber", "physicalAddress", "postalAddress"]
      : ["contactPerson", "contactNumber", "email", "organizationObjectives", "constitutionDocument"];
          ...
          <>
            <div className="space-y-2">
              ...
              {errors.organizationName && (
                <p className="text-red-500 text-sm">{errors.organizationName.message as React.ReactNode}</p>
              )}
            </div>
            <div className="space-y-2">
              ...
              <RadioGroup
                defaultValue="cipc"
                onValueChange={(value) => setValue("registrationMethod", value as "cipc" | "trust" | "other")}
              >
              ...
              {errors.registrationMethod && (
                <p className="text-red-500 text-sm">{errors.registrationMethod.message as React.ReactNode}</p>
              )}
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              {errors.physicalAddress && (
                <p className="text-red-500 text-sm">{errors.physicalAddress.message as React.ReactNode}</p>
              )}
            </div>
            <div className="space-y-2">
              ...
              {errors.postalAddress && (
                <p className="text-red-500 text-sm">{errors.postalAddress.message as React.ReactNode}</p>
              )}
            </div>
          </>
        )}
          ...
          <>
            <div className="space-y-2">
              ...
              {errors.contactPerson && (
                <p className="text-red-500 text-sm">{errors.contactPerson.message as React.ReactNode}</p>
              )}
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              {errors.organizationObjectives && (
                <p className="text-red-500 text-sm">{errors.organizationObjectives.message as React.ReactNode}</p>
              )}
            </div>
            <div className="space-y-2">
              ...
              {errors.constitutionDocument && (
                <p className="text-red-500 text-sm">{errors.constitutionDocument.message as React.ReactNode}</p>
              )}
            </div>
          </>
        )}
