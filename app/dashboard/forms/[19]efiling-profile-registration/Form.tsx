...
const formSchema = z.object({
  ...
  bankConfirmationLetter: z.any().refine((files) => files?.length > 0, "Bank confirmation letter is required"),
});
  ...
  const onSubmit: SubmitHandler<FormData> = async (data) => {
    try {
      ...
      Object.entries(data).forEach(([key, value]) => {
        if (key === "idPassportCopy" || key === "photoWithId" || key === "proofOfAddress" || key === "bankConfirmationLetter") {
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              />
              {errors.fullNames && (
                <p className="text-red-500 text-sm">{errors.fullNames.message}</p>
              )}
            </div>
            <div className="space-y-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Please provide your last 3 known cell numbers and email addresses</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              />
              {errors.cellNumber1 && (
                <p className="text-red-500 text-sm">{errors.cellNumber1.message}</p>
              )}
            </div>
            <div className="space-y-2">
              ...
              />
              {errors.cellNumber2 && (
                <p className="text-red-500 text-sm">{errors.cellNumber2.message}</p>
              )}
            </div>
            <div className="space-y-2">
              ...
              />
              {errors.cellNumber3 && (
                <p className="text-red-500 text-sm">{errors.cellNumber3.message}</p>
              )}
            </div>
            <div className="space-y-2">
              ...
              />
              {errors.email1 && (
                <p className="text-red-500 text-sm">{errors.email1.message}</p>
              )}
            </div>
            <div className="space-y-2">
              ...
              />
              {errors.email2 && (
                <p className="text-red-500 text-sm">{errors.email2.message}</p>
              )}
            </div>
            <div className="space-y-2">
              ...
              />
              {errors.email3 && (
                <p className="text-red-500 text-sm">{errors.email3.message}</p>
              )}
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              {errors.idPassportCopy && (
                <p className="text-red-500 text-sm">{errors.idPassportCopy.message as React.ReactNode}</p>
              )}
            </div>
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-gray-500">Upload a photo of yourself holding your ID and a sign that says "update my details". Ensure the information on the ID is clear and visible.</p>
              {errors.photoWithId && (
                <p className="text-red-500 text-sm">{errors.photoWithId.message as React.ReactNode}</p>
              )}
            </div>
            <div className="space-y-2">
              ...
              {errors.proofOfAddress && (
                <p className="text-red-500 text-sm">{errors.proofOfAddress.message as React.ReactNode}</p>
              )}
            </div>
            <div className="space-y-2">
              ...
              {errors.bankConfirmationLetter && (
                <p className="text-red-500 text-sm">{errors.bankConfirmationLetter.message as React.ReactNode}</p>
              )}
            </div>
          </CardContent>
        </Card>
