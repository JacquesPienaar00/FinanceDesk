  ...
  const onSubmit: SubmitHandler<FormData> = async (data) => {
    try {
      ...
      Object.entries(data).forEach(([key, value]) => {
        if (key === "bankConfirmationLetter" || key === "businessRegistrationDocument" || key === "priorYearFinancialStatements") {
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {hasPriorYearFinancialStatements === "yes" && (
              <div className="space-y-2">
                <Label htmlFor="priorYearFinancialStatements">Upload Prior Year Financial Statements</Label>
                <Input
