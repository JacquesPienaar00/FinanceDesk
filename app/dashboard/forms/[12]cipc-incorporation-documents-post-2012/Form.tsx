...
const formSchema = z.object({
  ...
  companyRegDocuments: z
    .any()
    .refine((files) => files?.length > 0, 'Company registration documents are required'),
});
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          {errors.cipcRegistrationNumber && (
            <p className="text-sm text-red-500">{errors.cipcRegistrationNumber.message}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          {errors.companyRegDocuments && (
            <p className="text-sm text-red-500">
              {errors.companyRegDocuments.message as React.ReactNode}
            </p>
          )}
        </div>
