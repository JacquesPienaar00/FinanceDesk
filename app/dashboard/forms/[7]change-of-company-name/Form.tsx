      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        {nameChangeType === "reserved" && (
          <div className="space-y-4">
            ...
            />
            {errors.reservedName && (
              <p className="text-red-500 text-sm">{errors.reservedName.message}</p>
            )}
            <Input
            ...
            {errors.reservationNumber && (
              <p className="text-red-500 text-sm">{errors.reservationNumber.message}</p>
            )}
          </div>
        )}
        ...
        {errors.currentCompanyName && (
          <p className="text-red-500 text-sm">{errors.currentCompanyName.message}</p>
        )}
        ...
        {errors.desiredCompanyName && (
          <p className="text-red-500 text-sm">{errors.desiredCompanyName.message}</p>
        )}
