...
export function ChangeOfDirectorsOrMembersForm({
  ...
  useEffect(() => {
    ...
    if (difference > 0) {
      ...
      for (let i = 0; i < -difference; i++)
        removeResigningDirector(resigningDirectorsFields.length - 1);
    }
  }, [
    resigningDirectorsCount,
    resigningDirectorsFields.length,
    appendResigningDirector,
    removeResigningDirector,
  ]);
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-4">
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              {errors.newDirectorsCount && (
                <p className="text-sm text-red-500">
                  {errors.newDirectorsCount.message as React.ReactNode}
                </p>
              )}
            </div>
            <div className="space-y-2">
              ...
              {errors.resigningDirectorsCount && (
                <p className="text-sm text-red-500">
                  {errors.resigningDirectorsCount.message as React.ReactNode}
                </p>
              )}
            </div>
          </>
        ...
        {currentStep === 1 && (
          <>
            <h3 className="mb-4 text-lg font-semibold">New Directors</h3>
              ...
              <div key={field.id} className="mb-6 space-y-4 rounded border p-4">
                ...
                <div className="space-y-2">
                  ...
                  {errors.newDirectors?.[index]?.name && (
                    <p className="text-sm text-red-500">
                      {errors.newDirectors[index]?.name?.message as React.ReactNode}
                    </p>
                  )}
                </div>
                <div className="space-y-2">
                  ...
                  {errors.newDirectors?.[index]?.surname && (
                    <p className="text-sm text-red-500">
                      {errors.newDirectors[index]?.surname?.message as React.ReactNode}
                    </p>
                  )}
                </div>
                <div className="space-y-2">
                  ...
                  {errors.newDirectors?.[index]?.email && (
                    <p className="text-sm text-red-500">
                      {errors.newDirectors[index]?.email?.message as React.ReactNode}
                    </p>
                  )}
                </div>
                <div className="space-y-2">
                  ...
                  {errors.newDirectors?.[index]?.idNumber && (
                    <p className="text-sm text-red-500">
                      {errors.newDirectors[index]?.idNumber?.message as React.ReactNode}
                    </p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {errors.newDirectors?.[index]?.homeAddress && (
                    <p className="text-sm text-red-500">
                      {errors.newDirectors[index]?.homeAddress?.message as React.ReactNode}
                    </p>
                  )}
                </div>
                <div className="space-y-2">
                  ...
                  {errors.newDirectors?.[index]?.postalAddress && (
                    <p className="text-sm text-red-500">
                      {errors.newDirectors[index]?.postalAddress?.message as React.ReactNode}
                    </p>
                  )}
                </div>
                <div className="space-y-2">
                  ...
                  {errors.newDirectors?.[index]?.cellNumber && (
                    <p className="text-sm text-red-500">
                      {errors.newDirectors[index]?.cellNumber?.message as React.ReactNode}
                    </p>
                  )}
                </div>
              </div>
            ...
            <h3 className="mb-4 mt-8 text-lg font-semibold">Resigning Directors</h3>
              ...
              <div key={field.id} className="mb-6 space-y-4 rounded border p-4">
                ...
                <div className="space-y-2">
                  ...
                  {errors.resigningDirectors?.[index]?.name && (
                    <p className="text-sm text-red-500">
                      {errors.resigningDirectors[index]?.name?.message as React.ReactNode}
                    </p>
                  )}
                </div>
                <div className="space-y-2">
                  ...
                  {errors.resigningDirectors?.[index]?.surname && (
                    <p className="text-sm text-red-500">
                      {errors.resigningDirectors[index]?.surname?.message as React.ReactNode}
                    </p>
                  )}
                </div>
                <div className="space-y-2">
                  ...
                  {errors.resigningDirectors?.[index]?.email && (
                    <p className="text-sm text-red-500">
                      {errors.resigningDirectors[index]?.email?.message as React.ReactNode}
                    </p>
                  )}
                </div>
                <div className="space-y-2">
                  ...
                  {errors.resigningDirectors?.[index]?.idNumber && (
                    <p className="text-sm text-red-500">
                      {errors.resigningDirectors[index]?.idNumber?.message as React.ReactNode}
                    </p>
                  )}
                </div>
              </div>
